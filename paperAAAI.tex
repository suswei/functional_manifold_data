...
\title{The Hidden Manifold Distance for Functional ata}
...
discretely-sampled realization of a continuous process. While one can
naively treat such data as vectors in Euclidean space, one may do better
to regard them as functional data. For certain types of functional data,
there is further structure to exploit, e.g.~probability density
functions or warped curves of a common template function. Namely, the
underlying curves of interest may lie on a manifold of low intrinsic
dimension. This work addresses the estimation of pairwise geodesic
