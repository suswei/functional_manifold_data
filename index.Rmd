...
###  Real data
A few examples of the datasets used by functional classification papers

* Wheat, rainfall and phoneme in "Achieving near-perfect classification for functional data"
* Berkeley growth curves in Chen et. al 2014, Biometrics.
* Tecator and phoneme in technometrics paper.