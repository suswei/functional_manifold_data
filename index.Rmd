...
\end{eqnarray*} 
where $f$ is the density of a N$(\beta,1/2)$ and the approximation in the next to last step comes from the fact that we are integrating on $[a,b]=[-4,4]$ and not on $\R$. 
...
```{r, echo=FALSE, eval=FaALSE, results='hide'}

setwd("./sim_results")
 
method_names=c("SS","s=1","s=2","s=3","L2")
