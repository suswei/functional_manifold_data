...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{sim_sce=2}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{sim_sce=4}
\caption{One hundred noisy curves in the functional manifold of square root probability density functions.}
\label{fig:sce4}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{sim_sce=5}
\caption{One hundred noisy curves in the functional manifold of warped functions.}
\label{fig:sce5}
\end{figure}
