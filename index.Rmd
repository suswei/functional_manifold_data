...
However, most shortest-path algorithms critically assume observations live on the manifold [@Yeh2005] and are thus likely to fail for functional data which are almost certainly observed with noise.
