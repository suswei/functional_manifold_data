...
## Basic differential geometry [Susan]
...
Alternatively, we can run the local version
```{r, eval=FALSE}
R compare_methods_local.R
```

Results are visualized by invoking cluster_results.R
```{r, eval=FALSE}
R cluster_results.R
```
